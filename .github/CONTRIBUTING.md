...
Thank you for your interest in improving the **Multimodal RAG Chatbot (AWS)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-aws-multimodal-chatbot.git
...
Generated configurations come from the **[Multimodal RAG Chatbot (AWS) Studio](https://pradeeptalari14.github.io/portfolio/tools/aws-multimodal-chatbot/)**.
