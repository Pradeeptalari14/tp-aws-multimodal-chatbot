# 🤖 Multimodal RAG Chatbot (AWS)

> AWS Bedrock assistant mapping multi-format documents using Amazon Textract and OpenSearch.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/aws-multimodal-chatbot/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-aws-multimodal-chatbot.git
cd tp-aws-multimodal-chatbot
```
...
```bash
kubectl port-forward deployment/tp-aws-multimodal-chatbot 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── textract_pipeline.py     # Main configuration file
```
...
---
*Generated by [Multimodal RAG Chatbot (AWS) Studio](https://pradeeptalari14.github.io/portfolio/tools/aws-multimodal-chatbot/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
