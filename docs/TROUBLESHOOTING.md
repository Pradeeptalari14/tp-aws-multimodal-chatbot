# 🔧 Troubleshooting Guide — Multimodal RAG Chatbot (AWS)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-aws-multimodal-chatbot/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/aws-multimodal-chatbot/)
